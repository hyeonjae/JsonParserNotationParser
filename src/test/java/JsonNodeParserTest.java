...
public class JsonNodeParserTest {
    ...
    public void testName() throws Exception {
        String payload = "{\"aaa\":{\"bbb\":{\"ccc\":\"hello\",\"ddd\":\"world\",\"eee\":[{\"fff\":\"fizz\"},{\"ggg\":\"buzz\"}]},\"hhh\":[[{\"iii\":\"apple\"}],[{\"jjj\":\"orange\"}],[{\"kkk\":\"banana\"}]]}}";
...
//        Assert.assertEquals(parser.get("aaa.lll[0][1].color").get(0), "blue");
//        Assert.assertEquals(parser.get("aaa.lll[0][2].color").get(0), "green");
